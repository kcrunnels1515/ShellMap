...
{ 
    ...
    $jobs += Start-Job -ScriptBlock $portScriptBlock -ArgumentList $hostIP, $port.PORT
}
...
# Attach the port scanning script block return object to the OVERALL output object
